...
export const parseActiveC4Contests = async (existingContests: ContestWithModules[]):Promise<ContestWithModules[]> => {
...
export const getActiveC4Contests = async () => {
  let contests: C4Contest[] = await axios.get("https://code4rena.com/contests", { headers: { rsc: 1 } }).catch(e => {
    console.log(`error ${e}`)
...
const getModulePathAndUrlBySplit = (pathAndUrl: string): {
